...
def on_open(self):
    ...
    #for p in pairs[0:1]:
        ...
        #self.send('{"op": "subscribe", "args": ["quote:XBTUSD"]}')
        #self.send('{"op": "subscribe", "args": "trade"}')
        #self.send(json.dumps({"op": "subscribe", "args": "tradeBin1m"}))
        self.send('{"op": "subscribe", "args": "orderBook10"}')
